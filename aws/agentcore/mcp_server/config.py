"""Runtime configuration loader for the AgentCore MCP Server container.
...
Layer 1 — Plain environment variables (non-sensitive)
    ...
    Examples:
        LTA_DATAMALL_BASE_URL = https://datamall2.mytransport.sg/ltaodataservice
...
Usage (call once at the top of server.py / app.py before importing tool modules):
